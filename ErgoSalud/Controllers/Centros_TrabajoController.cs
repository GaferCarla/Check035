...
namespace ErgoSalud.Controllers
{
    public class Centros_TrabajoController : Controller
    {
        ...
        private string directory = "C:/Inetpub/vhosts/Temp_data_Zips/Check035";
        //GENEROC:\Inetpub\vhosts\Temp_data_Zips
        ...
        public ActionResult Index()
        {
            ...
            var eRGOS_Centros_Trabajo_N01 = db.ERGOS_Centros_Trabajo_N01.Include(e => e.ERGOS_Empresas_N01).Where(E => E.deleted_at == null).Where(F => F.ERGOS_Empresas_N01.deleted_at == null).Where(G => G.id_empresa == id_empresa);
            return View(eRGOS_Centros_Trabajo_N01.ToList());
        }
        public ActionResult ZIP_Resultado_Individual(int id)
        {
            var url = HttpContext.Request.Url.Scheme + "://" + HttpContext.Request.Url.Authority + "/";
            var Lista_id_CT = (from E in db.ERGOS_Cuestionarios_Trabajador_N01 where E.id_centro_trabajo == id select new Getting_canalizados { Folio = E.id_cuestionario_trabajador, Nombre = E.Nombre, ID = E.id_trabajador }).ToList();

            SelectPdf.HtmlToPdf converter = new SelectPdf.HtmlToPdf();
            converter.Options.PdfPageSize = PdfPageSize.A4;
            converter.Options.WebPageWidth = 1250;
            ...
            foreach (var item in Lista_id_CT)
            {
                SelectPdf.PdfDocument pdf2 = converter.ConvertUrl(url + "Reportes/RInduirmBaf4AhwsdsaJ6fobQAreA9mBUt4dmB5CBNvjDfuIhma4ZpjMxmTosLw?id_CT=" + item.Folio);
                pdf2.Save(directory +"/Reportes_Resultados/Reporte_" + item.ID + "_" + item.Nombre + ".pdf");
            }
            ...
            {
                zip.AddDirectory(directory + "/Reportes_Resultados");
                zip.Save(outputStream);
            }

            Directory.Delete(directory + "/Reportes_Resultados", true);
            outputStream.Position = 0;
            return File(outputStream, "application/zip", "Reportes_Individuales.zip");
        }
        public ActionResult ZIP_Cuestionario_Individual(int id, int id_encuesta)
        {
            var url = HttpContext.Request.Url.Scheme + "://" + HttpContext.Request.Url.Authority + "/";
            var Lista_id_CT = (from E in db.ERGOS_Cuestionarios_Trabajador_N01 where E.id_centro_trabajo == id select new Getting_canalizados { Folio = E.id_cuestionario_trabajador, Nombre = E.Nombre, ID = E.id_trabajador }).ToList();


            string Nombre = (from E in db.ERGOS_Cuestionarios_Trabajador_N01 where E.id_cuestionario_trabajador == id select E.Nombre).FirstOrDefault();
            SelectPdf.HtmlToPdf converter = new SelectPdf.HtmlToPdf();
            converter.Options.PdfPageSize = PdfPageSize.A4;
            converter.Options.WebPageWidth = 1250;
            converter.Options.MarginLeft = 10;
            ...
            foreach (var item in Lista_id_CT)
            {
                SelectPdf.PdfDocument pdf = converter.ConvertUrl(url + "Reportes/AOwYbqttJ6fobQAreA9mBUt4dmB5CBtuirmBaf4AhwNvjDfuIhma4ZpjMxmTosLw?id_CT=" + item.Folio + "&id_C=" + id_encuesta);
                pdf.Save(directory + "/Encuestas/Encuesta_" + item.ID + "_"+item.Nombre+".pdf");
            }
            var outputStream = new MemoryStream();

            using (var zip = new ZipFile())
            {
                zip.AddDirectory(directory + "/Encuestas");
                zip.Save(outputStream);
            }

            Directory.Delete(directory + "/Encuestas", true);
            outputStream.Position = 0;
            return File(outputStream, "application/zip", "Encuestas.zip");
        }

        public ActionResult ZIP_Resultado_Individual_CL(int id)
        {
            var url = HttpContext.Request.Url.Scheme + "://" + HttpContext.Request.Url.Authority + "/";
            var Lista_id_CT = (from E in db.ClimaLaboral_Cuestionario_Resultados_N01 where E.ERGOS_Cuestionarios_Trabajador_N01.id_centro_trabajo == id select new Getting_canalizados { Folio = E.id_cuestionario_resultado, Nombre = E.ERGOS_Cuestionarios_Trabajador_N01.Nombre, ID = E.ERGOS_Cuestionarios_Trabajador_N01.id_trabajador }).ToList();
            ...
            foreach (var item in Lista_id_CT)
            {
                SelectPdf.PdfDocument pdf2 = converter.ConvertUrl(url + "Reportes/RIndCLMAuirmBaf4AhwsdsaJ6fobQAreA9mBUt4dmB5CBNvjDfuIhma4ZpjMxmTosLw?id_CT=" + item.Folio); 
                pdf2.Save(directory + "/Reportes_Resultados/Reporte_" + item.ID + "_" + item.Nombre + ".pdf");
            }
        ...
        public ActionResult ZIP_Cuestionario_Individual_CL(int id)
        {
            var url = HttpContext.Request.Url.Scheme + "://" + HttpContext.Request.Url.Authority + "/";
            var Lista_id_CT = (from E in db.ClimaLaboral_Cuestionario_Resultados_N01 where E.ERGOS_Cuestionarios_Trabajador_N01.id_centro_trabajo == id select new Getting_canalizados { Folio = E.id_cuestionario_resultado, Nombre = E.ERGOS_Cuestionarios_Trabajador_N01.Nombre, ID = E.ERGOS_Cuestionarios_Trabajador_N01.id_trabajador }).ToList();
            ...
            foreach (var item in Lista_id_CT)
            {
                SelectPdf.PdfDocument pdf = converter.ConvertUrl(url + "Reportes/AOwCLMAYbqttJ6fobQAreA9mBUt4dmB5CBtuirmBaf4AhwNvjDfuIhma4ZpjMxmTosLw?id_CT=" + item.Folio);
                pdf.Save(directory + "/Encuestas/Encuesta_" + item.ID + "_" + item.Nombre + ".pdf");
            }
            var outputStream = new MemoryStream();
        ...
        public ActionResult ZIP_Resultado_Individual_E360(int id)
        {
            var url = HttpContext.Request.Url.Scheme + "://" + HttpContext.Request.Url.Authority + "/";
            var Lista_id_CT = (from E in db.E360_Cuestionario_Resultado_N01 where E.ERGOS_Cuestionarios_Trabajador_N01.id_centro_trabajo == id select new Getting_canalizados { Folio = E.id_cuestionario_resultado, Nombre = E.ERGOS_Cuestionarios_Trabajador_N01.Nombre, ID = E.ERGOS_Cuestionarios_Trabajador_N01.id_trabajador }).ToList();
            ...
            foreach (var item in Lista_id_CT)
            { 
                int? Evaluando = (from E in db.E360_Cuestionario_Resultado_N01 where E.id_cuestionario_trabajador == item.Folio select E.id_CT_Evaluado).FirstOrDefault();

                SelectPdf.PdfDocument pdf2 = converter.ConvertUrl(url + "Reportes/RIndE360jsdhkdsgbf894378uyfsb9834t8hskdjgh3894ghoi987y4398duicfkgn509ufhhfg4Lw?id_CT=" + item.Folio); 
                pdf2.Save(directory + "/Reportes_Resultados/Reporte_E360" + item.ID + "_" + item.Nombre + "_" + item.Folio + ".pdf"); 
            }
        ...
        public ActionResult ZIP_Cuestionario_Individual_E360(int id)
        {
            var url = HttpContext.Request.Url.Scheme + "://" + HttpContext.Request.Url.Authority + "/";
            var Lista_id_CT = (from E in db.E360_Cuestionario_Resultado_N01 where E.ERGOS_Cuestionarios_Trabajador_N01.id_centro_trabajo == id select new Getting_canalizados { Folio = E.id_cuestionario_resultado, Nombre = E.ERGOS_Cuestionarios_Trabajador_N01.Nombre, ID = E.ERGOS_Cuestionarios_Trabajador_N01.id_trabajador }).ToList();
            ...
            foreach (var item in Lista_id_CT)
            {
                ...
                SelectPdf.PdfDocument pdf = converter.ConvertUrl(url + "Reportes/AOwE360YbqttJ6foDFHDFHDFHf4AhwNvjDfuDFHDFHjMxmTo7UJYHTG45HBRF23SD4DGFFas?id_CT=" + item.Folio);
                pdf.Save(directory + "/Encuestas/Encuesta_E360" + item.ID + "_" + item.Nombre + "_" + item.Folio + ".pdf");
            }
            var outputStream = new MemoryStream();
        ...
        public ActionResult Index_CT_admin_sys()
        {

            var eRGOS_Centros_Trabajo_N01 = db.ERGOS_Centros_Trabajo_N01.Include(e => e.ERGOS_Empresas_N01).Where(E => E.deleted_at == null).Where(F => F.ERGOS_Empresas_N01.deleted_at == null);
            return View(eRGOS_Centros_Trabajo_N01.ToList());
        }
        ...
        public JsonResult Searching_Gender(int id_empresa, int id_survey)
        {
            ...
            //####################################################################################################################
            string Total_Empresa = "SELECT [dbo].[fnDemo_N035_Final_Centro_Trabajo] ({0})";
            ...
            int Total_Surveys = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_H = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Sexo == 1 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_M = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Sexo == 2 select new { G.id_centro_trabajo }).Count();
        ...
        public JsonResult Searching_Edo_Civil(int id_empresa, int id_survey)
        {
            ...
            int? Total_Reporte_Casados = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                          ...
                                          where CT.id_centro_trabajo == id_empresa && CT.Estado_Civil == 1
            ...
            int? Total_Reporte_Solteros = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                           join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                           where CT.id_centro_trabajo == id_empresa && CT.Estado_Civil == 2
                                           select G.Calificacion).Sum();
            ...
            int? Total_Reporte_Divorciados = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                              join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                              where CT.id_centro_trabajo == id_empresa && CT.Estado_Civil == 3
                                              select G.Calificacion).Sum();
            ...
            int? Total_Reporte_Union_Libre = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                              join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                              where CT.id_centro_trabajo == id_empresa && CT.Estado_Civil == 4
                                              select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_Viudos = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                         join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                         where CT.id_centro_trabajo == id_empresa && CT.Estado_Civil == 5
                                         select G.Calificacion).Sum();
            //#########################################################################################################################################################
            int Total_Surveys = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_CA = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Estado_Civil == 1 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_SO = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Estado_Civil == 2 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_DI = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Estado_Civil == 3 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_UL = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Estado_Civil == 4 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_VI = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Estado_Civil == 5 select new { G.id_centro_trabajo }).Count();
        ...
        public JsonResult Searching_Nivel_Estudios(int id_empresa, int id_survey)
        {
            ...
            int? Total_Reporte_Sin_Info = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                           join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                           where CT.id_centro_trabajo == id_empresa && CT.Nivel_Estudios == 1
                                           select G.Calificacion).Sum();
            ...
            int? Total_Reporte_Primaria = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                           join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                           where CT.id_centro_trabajo == id_empresa && CT.Nivel_Estudios == 2
                                           select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_Secundaria = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                             join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                             where CT.id_centro_trabajo == id_empresa && CT.Nivel_Estudios == 3
                                             select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_Preparatoria = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                               join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                               where CT.id_centro_trabajo == id_empresa && CT.Nivel_Estudios == 4
                                               select G.Calificacion).Sum();
            ...
            int? Total_Reporte_Tecnico = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                          join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                          where CT.id_centro_trabajo == id_empresa && CT.Nivel_Estudios == 5
                                          select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_Licenciatura = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                               join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                               where CT.id_centro_trabajo == id_empresa && CT.Nivel_Estudios == 6
                                               select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_Maestria = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                           join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                           where CT.id_centro_trabajo == id_empresa && CT.Nivel_Estudios == 7
                                           select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_Doctorado = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                            join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                            where CT.id_centro_trabajo == id_empresa && CT.Nivel_Estudios == 8
                                            select G.Calificacion).Sum();

            //#########################################################################################################################################################
            int Total_Surveys = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_1 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Nivel_Estudios == 1 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_2 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Nivel_Estudios == 2 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_3 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Nivel_Estudios == 3 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_4 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Nivel_Estudios == 4 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_5 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Nivel_Estudios == 5 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_6 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Nivel_Estudios == 6 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_7 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Nivel_Estudios == 7 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_8 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Nivel_Estudios == 8 select new { G.id_centro_trabajo }).Count();
        ...
        public JsonResult Searching_Tipo_Personal(int id_empresa, int id_survey)
        {
            ...
            int? Total_Reporte_Sin_Info = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                           join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                           where CT.id_centro_trabajo == id_empresa && CT.Tipo_Personal == 1
                                           select G.Calificacion).Sum();
            ...
            int? Total_Reporte_Primaria = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                           join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                           where CT.id_centro_trabajo == id_empresa && CT.Tipo_Personal == 2
                                           select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_Secundaria = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                             join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                             where CT.id_centro_trabajo == id_empresa && CT.Tipo_Personal == 3
                                             select G.Calificacion).Sum();

            //#########################################################################################################################################################
            int Total_Surveys = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_1 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Tipo_Personal == 1 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_2 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Tipo_Personal == 2 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_3 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Tipo_Personal == 3 select new { G.id_centro_trabajo }).Count();
        ...
        public JsonResult Searching_Tipo_Contratacion(int id_empresa, int id_survey)
        {
            ...
            int? Total_Reporte_1 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                    join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                    where CT.id_centro_trabajo == id_empresa && CT.Tipo_Contratacion == 1
                                    select G.Calificacion).Sum();
            ...
            int? Total_Reporte_2 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                    join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                    where CT.id_centro_trabajo == id_empresa && CT.Tipo_Contratacion == 2
                                    select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_3 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                    join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                    where CT.id_centro_trabajo == id_empresa && CT.Tipo_Contratacion == 3
                                    select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_4 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                    join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                    where CT.id_centro_trabajo == id_empresa && CT.Tipo_Contratacion == 4
                                    select G.Calificacion).Sum();


            //#########################################################################################################################################################
            int Total_Surveys = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_1 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Tipo_Contratacion == 1 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_2 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Tipo_Contratacion == 2 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_3 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Tipo_Contratacion == 3 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_4 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Tipo_Contratacion == 4 select new { G.id_centro_trabajo }).Count();
        ...
        public JsonResult Searching_Tipo_Puesto(int id_empresa, int id_survey)
        {
            ...
            int? Total_Reporte_Sin_Info = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                           join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                           where CT.id_centro_trabajo == id_empresa && CT.Tipo_puesto == 1
                                           select G.Calificacion).Sum();
            ...
            int? Total_Reporte_Primaria = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                           join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                           where CT.id_centro_trabajo == id_empresa && CT.Tipo_puesto == 2
                                           select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_Secundaria = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                             join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                             where CT.id_centro_trabajo == id_empresa && CT.Tipo_puesto == 3
                                             select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_Preparatoria = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                               join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                               where CT.id_centro_trabajo == id_empresa && CT.Tipo_puesto == 4
                                               select G.Calificacion).Sum();

            //#########################################################################################################################################################
            int Total_Surveys = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_1 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Tipo_puesto == 1 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_2 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Tipo_puesto == 2 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_3 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Tipo_puesto == 3 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_4 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Tipo_puesto == 4 select new { G.id_centro_trabajo }).Count();
        ...
        public JsonResult Searching_Rotacion_Turno(int id_empresa, int id_survey)
        {
            ...
            int? Total_Reporte_1 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                    join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                    where CT.id_centro_trabajo == id_empresa && CT.Rotacion_Turno == 1
                                    select G.Calificacion).Sum();
            ...
            int? Total_Reporte_2 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                    join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                    where CT.id_centro_trabajo == id_empresa && CT.Rotacion_Turno == 2
                                    select G.Calificacion).Sum();

            //#########################################################################################################################################################
            int Total_Surveys = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_1 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Rotacion_Turno == 1 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_2 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Rotacion_Turno == 2 select new { G.id_centro_trabajo }).Count();
        ...
        public JsonResult Searching_Tipo_Jornada(int id_empresa, int id_survey)
        {
            ...
            int? Total_Reporte_1 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                    join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                    where CT.id_centro_trabajo == id_empresa && CT.Tipo_Jornada == 1
                                    select G.Calificacion).Sum();
            ...
            int? Total_Reporte_2 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                    join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                    where CT.id_centro_trabajo == id_empresa && CT.Tipo_Jornada == 2
                                    select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_3 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                    join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                    where CT.id_centro_trabajo == id_empresa && CT.Tipo_Jornada == 3
                                    select G.Calificacion).Sum();

            //#########################################################################################################################################################
            int Total_Surveys = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_1 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Tipo_Jornada == 1 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_2 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Tipo_Jornada == 2 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_3 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Tipo_Jornada == 3 select new { G.id_centro_trabajo }).Count();
        ...
        public JsonResult Searching_Edades(int id_empresa, int id_survey)
        {
            ...
            int? Total_Reporte_15_19 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                        join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                        where CT.id_centro_trabajo == id_empresa && CT.Edad == 1
                                        select G.Calificacion).Sum();
            ...
            int? Total_Reporte_20_24 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                        join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                        where CT.id_centro_trabajo == id_empresa && CT.Edad == 2
                                        select G.Calificacion).Sum();
            ...
            int? Total_Reporte_25_29 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                        join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                        where CT.id_centro_trabajo == id_empresa && CT.Edad == 3
                                        select G.Calificacion).Sum();
            ...
            int? Total_Reporte_30_34 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                        join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                        where CT.id_centro_trabajo == id_empresa && CT.Edad == 4
                                        select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_35_39 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                        join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                        where CT.id_centro_trabajo == id_empresa && CT.Edad == 5
                                        select G.Calificacion).Sum();
            ...
            int? Total_Reporte_40_44 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                        join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                        where CT.id_centro_trabajo == id_empresa && CT.Edad == 6
                                        select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_45_49 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                        join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                        where CT.id_centro_trabajo == id_empresa && CT.Edad == 7
                                        select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_50_54 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                        join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                        where CT.id_centro_trabajo == id_empresa && CT.Edad == 8
                                        select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_55_59 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                        join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                        where CT.id_centro_trabajo == id_empresa && CT.Edad == 9
                                        select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_60_64 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                        join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                        where CT.id_centro_trabajo == id_empresa && CT.Edad == 10
                                        select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_65_69 = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                        join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                        where CT.id_centro_trabajo == id_empresa && CT.Edad == 11
                                        select G.Calificacion).Sum();
            //####################################################################################################################
            ...
            int? Total_Reporte_70_X = (from G in db.ERGOS_Cuestionarios_Resultados_N01
                                       join CT in db.ERGOS_Cuestionarios_Trabajador_N01 on G.id_cuestionario_trabajador equals CT.id_cuestionario_trabajador
                                       where CT.id_centro_trabajo == id_empresa && CT.Edad == 12
                                       select G.Calificacion).Sum();
            //####################################################################################################################

            int Total_Surveys = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_1 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Edad == 1 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_2 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Edad == 2 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_3 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Edad == 3 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_4 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Edad == 4 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_5 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Edad == 5 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_6 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Edad == 6 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_7 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Edad == 7 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_8 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Edad == 8 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_9 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Edad == 9 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_10 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Edad == 10 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_11 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Edad == 11 select new { G.id_centro_trabajo }).Count();
            int Total_Surveys_12 = (from G in db.ERGOS_Cuestionarios_Trabajador_N01 where G.id_centro_trabajo == id_empresa && G.Edad == 12 select new { G.id_centro_trabajo }).Count();
        ...
        public void Colores_Dimensiones_S2(int? id)
        {
        ...
        [Authorize(Roles = "Admin-Guest,Admin_Centro")]
        public ActionResult General_Statistics(int id)
        {
            string UserName = User.Identity.Name;
          //  int? id = (from E in db.ERGOS_Usuarios_N01 where E.User_Nombre == UserName select E.id_centro_trabajo).FirstOrDefault();
            ...
            ViewBag.Centro_Trabajo = id;
            ViewBag.Centro_Trabajo_Nombre = (from E in db.ERGOS_Centros_Trabajo_N01 where E.id_centro_trabajo == id select E.Nombre_centro_trabajo).FirstOrDefault();
        ...
        [Authorize(Roles = "Admin,Admin_SyS")]
        public ActionResult General_Statistics_Admin(int id, int id_encuesta)
        {
            ViewBag.Survey = id_encuesta;
            ViewBag.id_empresa = id;
        ...
        public ActionResult Reporte_General_PDF(int id, int id_C)
        {
            ...
            converter.Footer.Height = 30;
            converter.Options.PdfPageOrientation = PdfPageOrientation.Portrait;
            SelectPdf.PdfDocument pdf1 = converter.ConvertUrl(url + "Reportes_Centro/ReGCTOwgfttJ6fobQArasdfg5dh7e3auhgfd656mxghhgf6hghIhma4Zpgf4osLw?id=" + id + "&id_encuesta=" + id_C);
        ...
        public ActionResult Reporte_General_PDF_CL(int id_centro)
        {
            var url = HttpContext.Request.Url.Scheme + "://" + HttpContext.Request.Url.Authority + "/";
            string centro_trabajo_nombre = (from Company in db.ERGOS_Centros_Trabajo_N01
                                            where Company.id_centro_trabajo == id_centro
                                            select Company.Nombre_centro_trabajo).FirstOrDefault();
            int? id_empresa = (from Company in db.ERGOS_Centros_Trabajo_N01
                               where Company.id_centro_trabajo == id_centro
                               select Company.id_empresa).FirstOrDefault();
            SelectPdf.HtmlToPdf converter = new SelectPdf.HtmlToPdf();
            converter.Options.DisplayHeader = true;
            converter.Options.DisplayFooter = true;
            converter.Header.DisplayOnFirstPage = false;
            ...
            converter.Footer.Height = 30;
            converter.Options.PdfPageOrientation = PdfPageOrientation.Portrait;
            SelectPdf.PdfDocument pdf1 = converter.ConvertUrl(url + "Reportes_Centro/ReGCT_CL098UHBVCFRYUasasOwgfttJ6fobQArasdfg5dh7e3fgdgfggh65gdgfpgf4osLw?id_e=" + id_empresa + "&id_c=" + id_centro);

            return File(pdf1.Save(), "application/pdf;", centro_trabajo_nombre + "_Reporte_Final.pdf");
        }
        public ActionResult Reporte_General_PDF_E360(int id_centro)
        {
            var url = HttpContext.Request.Url.Scheme + "://" + HttpContext.Request.Url.Authority + "/";
            string centro_trabajo_nombre = (from Company in db.ERGOS_Centros_Trabajo_N01
                                            where Company.id_centro_trabajo == id_centro
            ...
            converter.Footer.Height = 30;
            converter.Options.PdfPageOrientation = PdfPageOrientation.Portrait;
            SelectPdf.PdfDocument pdf1 = converter.ConvertUrl(url + "Reportes_Centro/ReGCT_E360OwgfDFGHJKJHGFDgf6hgh76TFD44osLw?id_e=" + id_empresa + "&id_c=" + id_centro);

            return File(pdf1.Save(), "application/pdf;", centro_trabajo_nombre + "_Reporte_Final.pdf");
        }
        public ActionResult Reporte_General_ind_covid()
        {
            var url = HttpContext.Request.Url.Scheme + "://" + HttpContext.Request.Url.Authority + "/";
            ...
            converter.Footer.Height = 30;
            converter.Options.PdfPageOrientation = PdfPageOrientation.Portrait;
            SelectPdf.PdfDocument pdf1 = converter.ConvertUrl(url + "Reportes_Centro/Covid_19");
            //var html = new System.Net.WebClient().DownloadString(url + "Reportes/ReGOwYbqttJ6fobQArasdsdsdHIhihisdih876AhwNvjDfGFasauIhma4ZpjMxmTosLw?id=" + id);

            return File(pdf1.Save(), "application/pdf;", "Covid_Reporte.pdf");
            //return File(pdf.Save(), "application/pdf;", "Reporte_Final.pdf");
        }
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.id_empresa = new SelectList(db.ERGOS_Empresas_N01.Where(E => E.deleted_at == null).Where(x => x.id_empresa == id_empresa), "id_empresa", "Razon_Social");
            //ViewBag.id_compañeros = new SelectList(db.ERGOS_Cuestionarios_Trabajador_N01.Where(E => E.deleted_at == null), "id_empresa", "Razon_Social");
        ...
        public ActionResult Create(ERGOS_Centros_Trabajo_N01 eRGOS_Centros_Trabajo_N01)
        {
            ...
            ViewBag.id_empresa = new SelectList(db.ERGOS_Empresas_N01, "id_empresa", "Razon_Social", eRGOS_Centros_Trabajo_N01.id_empresa);
            return View(eRGOS_Centros_Trabajo_N01);
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.id_empresa = new SelectList(db.ERGOS_Empresas_N01.Where(c => c.deleted_at == null), "id_empresa", "Razon_Social", eRGOS_Centros_Trabajo_N01.id_empresa);

            int? Id_Survey = (from Depts in db.ERGOS_Centros_Trabajo_N01
                              where Depts.id_centro_trabajo == id
                              select Depts.ERGOS_Empresas_N01.id_encuesta).FirstOrDefault();

            ViewBag.id_encuesta = Id_Survey;
            return View(eRGOS_Centros_Trabajo_N01);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(ERGOS_Centros_Trabajo_N01 eRGOS_Centros_Trabajo_N01)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            try
            {
                ...
                { 
                    return RedirectToAction("Index_CT_admin_sys");
                }
                else
                {
                    return RedirectToAction("Index");
                ...
                TempData["Delete_failed"] = "  Existe información casada a este registro elimine centros y/o evaluaciones primeramente para poder continuar";
